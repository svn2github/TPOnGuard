...
begin
  FOgCodeBase := TOgCodeBase.Create;
end;
...
begin
  FOgMakeCodes := TOgMakeCodes.Create;
end;
...
begin
  FOgMakeKeys := TOgMakeKeys.Create;
end;
...
begin
  FOgDateCode := TOgDateCode.Create;
end;
...
begin
  FOgDaysCode := TOgDaysCode.Create;
end;
...
begin
  FOgRegistrationCode := TOgRegistrationCode.Create;
end;
...
begin
  FOgSerialNumberCode := TOgSerialNumberCode.Create;
end;
...
begin
  FOgSpecialCode := TOgSpecialCode.Create;
end;
...
begin
  FOgUsageCode := TOgUsageCode.Create;
end;
